...
- **`void-docker-gh`** is the `para init` default, a small, complete Docker demo
  that exercises the whole mechanism.
- **`void-minimal`** is the barest box. It installs and runs nothing, with
  comments marking where your stack goes.
